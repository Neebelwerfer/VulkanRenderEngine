...
void GraphicsInterface::Render() 
{
	...
	uint32_t imageIndex;
	vkAcquireNextImageKHR(m_device.GetHandle(), m_device.GetSwapchainHandle(), UINT64_MAX, m_imageAvailableSemaphoreHandles[m_currentFrame], VK_NULL_HANDLE, &imageIndex);
